...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          // Directly apply the dark background and text color
          ...
          style={
            {
              ...
              "--white-gradient": // This might still be referenced, but its effect will be minimal or overridden
        ...
        >
          <div
            className={cn(
              ...
              invert-0`, // Ensures no color inversion from light mode
              showRadialGradient &&
